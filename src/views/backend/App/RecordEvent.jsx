...
const RecordEvent = () => {
    ...
    const styles = {
        ...
        breadcrumb: { marginBottom: '20px', color: '#888' },
        form: { display: 'flex', flexDirection: 'column', gap: '15px', maxWidth: '600px' },
        input: {
            width: '100%',
            padding: '10px',
        ...
        <div style={styles.container}>
            ...
            <form style={styles.form}>
                ...
                <div style={styles.dynamicSection}>
                    {eventType === 'Accident' && (
                        <>
                            ...
                            <input type="number" style={styles.input} placeholder="Claim Amount" />
                        </>
                    )}
                    {eventType === 'Incident' && (
                        <>
                            ...
                            <input type="number" style={styles.input} placeholder="Invoice Amount" />
                            <input type="date" style={styles.input} placeholder="Invoice Date" />
                            <input type="date" style={styles.input} placeholder="Closure Date" />
                            <input type="file" style={styles.fileInput} multiple />
                        </>
                    )}
                    {eventType === 'Ticket' && (
                        <>
                            <input type="number" style={styles.input} placeholder="Company Fee" />
                            <input type="file" style={styles.fileInput} />
                ...
                <div>
                    ...
                    <button style={styles.buttonSecondary} type="button" onClick={() => console.log('Cancel')}>
                        Cancel
                    </button>
                </div>
            </form>

        ...
        return Object.keys(menuData || {}).map((menuKey) => {
            ...
            return (
                <li className="sidebar-layout" key={menuKey}>
                    <Accordion.Toggle as={Button} eventKey={menuKey} variant=" collapsed" data-toggle="collapse" aria-expanded={activeMenu === '0' ? 'true' : 'false'} >
                        <i>
                    ...
                    <Accordion.Collapse className="submenu" eventKey={menuKey}>
                        <ul className="submenu">
                            {subMenu.map((item) => (
                                <li key={item}>
                                    <Link to={`/${basePath}${item.toLowerCase()}`} className="svg-icon">
                                        <i className="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 012 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                            </svg>
                                        </i>
